...
<Settings>
    <Systems>
        <System Name="Windows">
            <Models>
                <!-- Model File="%USERPROFILE%/LocalKiModels/DeepSeek-R1-Distill-Qwen-1.5B.Q5_K_M.gguf" Current="true"/>
                <Model File="%USERPROFILE%/LocalKiModels/qwen2.5-coder-7b-instruct-q5_k_m.gguf"  / -->
            </Models>
            <LLamaCpp>
